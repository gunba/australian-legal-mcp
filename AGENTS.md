...
V0.19.5 hard-cuts host tools to one V2 transaction. It accepts either the
...
v0.19.5 release exists: once its immutable bundle is available, verify it,
upgrade with `--upgrade-host-tools --version 0.19.5`, configure authentication,
