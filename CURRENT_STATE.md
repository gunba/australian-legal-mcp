...
The software tree is 0.19.5. The active local generation is
...
failure never triggers abort automatically. V0.19.5 hard-cuts the upgrade to a
...
2. Once the immutable v0.19.5 artifacts exist, independently verify the Linux
