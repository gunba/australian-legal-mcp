...
Software is version 0.19.4. The active local v20 generation is
...
V0.19.4 implements a hard-cut V2 host-tools transaction for either a prepared
...
uses the same bundle and leaves service/ingress off. Once the v0.19.4 release
exists, verify its bundle, run `--upgrade-host-tools --version 0.19.4`, configure
