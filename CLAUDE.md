...
V0.19.5 implements one hard-cut V2 host-tools transaction for either a
...
The operation leaves service and ingress off. Once the v0.19.5 release bundle
exists, verify it, upgrade with `--upgrade-host-tools --version 0.19.5`,
