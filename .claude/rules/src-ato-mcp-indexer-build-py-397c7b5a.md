...
- [IB-16 L794] Window preparation parallelises HTML extract + chunking via ProcessPoolExecutor with workers = max(1, cpu_count - 1); only the embed + DB-write phases stay single-threaded since they hold the SQLite transaction.
