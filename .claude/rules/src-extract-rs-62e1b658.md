...
- [IB-18 L1115] doc_id is the ATO docid query path verbatim with prefix/case/slashes preserved; missing or malformed canonical URLs fall back to canonical_id so every source record has a stable key.
