...
- [SS-04 L93] Default refresh_source pacing: request_interval=0.5s, max_workers=1. Concurrency is intentionally restrained — the rate lock would serialise anyway, and anything faster risks tripping ATO's rate guard.
